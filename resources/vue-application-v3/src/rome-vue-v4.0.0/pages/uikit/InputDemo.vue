                ...
                <MultiSelect v-model="multiselectValue" :options="multiselectValues" optionLabel="name" placeholder="Select Countries" :filter="true" class="multiselect-custom">
                    <template #value="slotProps">
                        <div class="country-item country-item-value" v-for="option of slotProps.value" :key="option.code">
                            <img src="/demo/flags/flag_placeholder.png" :class="'flag flag-' + option.code.toLowerCase()" />
                            <div>{{ option.name }}</div>
                        </div>
                    ...
                    <template #option="slotProps">
                        <div class="country-item">
                            <img src="/demo/flags/flag_placeholder.png" :class="'flag flag-' + slotProps.option.code.toLowerCase()" />
...
<script>
import CountryService from '@/rome-vue-v4.0.0/services/CountryService';
import NodeService from '@/rome-vue-v4.0.0/services/NodeService';
export default {
    data() {
        return {
            floatValue: null,
