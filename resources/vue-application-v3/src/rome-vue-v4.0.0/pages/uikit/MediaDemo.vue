                    ...
                    <template #item="product">
                        <div class="product-item">
                            <div class="product-item-content">
                                <div class="mb-3">
                                    <img :src="'@/rome-vue-v4.0.0/demo/images/product/' + product.data.image" :alt="product.data.name" class="product-image" />
                                </div>
                                <div>
                                    <h4 class="mb-1">
                                        {{ product.data.name }}
        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="flex justify-content-center">
                    <Image src="@/rome-vue-v4.0.0/demo/images/galleria/galleria11.jpg" alt="Image" width="250" preview />
                </div>
            </div>
        </div>
    </div>
...
import PhotoService from '@/rome-vue-v4.0.0/services/PhotoService';
export default {
    data() {
        return {
            products: [],
