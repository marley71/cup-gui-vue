    ...
    <div class="grid misc-demo">
        ...
        <div class="col-12 lg:col-6">
            ...
            <div class="card">
                ...
                <AvatarGroup class="mb-3">
                    <Avatar image="@/rome-vue-v4.0.0/demo/images/avatar/amyelsner.png" size="large" shape="circle"></Avatar>
                    <Avatar image="@/rome-vue-v4.0.0/demo/images/avatar/asiyajavayant.png" size="large" shape="circle"></Avatar>
                    <Avatar image="@/rome-vue-v4.0.0/demo/images/avatar/onyamalimba.png" size="large" shape="circle"></Avatar>
                    <Avatar image="@/rome-vue-v4.0.0/demo/images/avatar/ionibowcher.png" size="large" shape="circle"></Avatar>
                    <Avatar image="@/rome-vue-v4.0.0/demo/images/avatar/xuxuefeng.png" size="large" shape="circle"></Avatar>
        ...
        <div class="col-12 lg:col-6">
            ...
            <div class="card">
                ...
                <div class="flex align-items-center flex-column sm:flex-row">
                    <Chip label="Amy Elsner" image="@/rome-vue-v4.0.0/demo/images/avatar/amyelsner.png" class="mr-2 mb-2"></Chip>
                    <Chip label="Asiya Javayant" image="@/rome-vue-v4.0.0/demo/images/avatar/asiyajavayant.png" class="mr-2 mb-2"></Chip>
                    <Chip label="Onyama Limba" image="@/rome-vue-v4.0.0/demo/images/avatar/onyamalimba.png" class="mr-2 mb-2"></Chip>
                    <Chip label="Xuxue Feng" image="@/rome-vue-v4.0.0/demo/images/avatar/xuxuefeng.png" :removable="true" class="mb-2"></Chip>
                </div>
                ...
                <div class="flex align-items-center flex-column sm:flex-row">
                    ...
                    <Chip label="Onyama Limba" image="@/rome-vue-v4.0.0/demo/images/avatar/onyamalimba.png" class="mr-2 mb-2 custom-chip"></Chip>
                    <Chip label="Xuxue Feng" image="@/rome-vue-v4.0.0/demo/images/avatar/xuxuefeng.png" :removable="true" class="mb-2 custom-chip"></Chip>
                </div>
            </div>
