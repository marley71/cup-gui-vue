                    ...
                    <template #list="slotProps">
                        <div class="col-12">
                            <div class="flex flex-column md:flex-row align-items-center p-3 w-full">
                                <img :src="'@/rome-vue-v4.0.0/demo/images/product/' + slotProps.data.image" :alt="slotProps.data.name" class="my-4 md:my-0 w-9 md:w-10rem shadow-2 mr-0 md:mr-5" />
                        ...
                        <div class="col-12 md:col-4">
                            <div class="card m-3 border-1 surface-border">
                                ...
                                <div class="flex flex-column align-items-center">
                                    <img :src="'@/rome-vue-v4.0.0/demo/images/product/' + slotProps.data.image" :alt="slotProps.data.name" class="w-9 shadow-2 my-3 mx-0" />
