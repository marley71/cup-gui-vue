            ...
            <div class="overflow-y-auto flex-1 p-2 flex flex-col gap-4">
                <ul class="list-none m-0 flex flex-col gap-1">
                    <li>
                        ...
                        >
                            <span class="font-semibold text-base leading-tight text-primary-contrast">Home</span>
                        ...
                        <ul class="list-none m-0 overflow-hidden flex flex-col gap-1 mt-1">
                            ...
                            <li>
                                <a class="flex items-center cursor-pointer p-3 gap-2 rounded-lg text-primary-contrast hover:bg-primary-emphasis transition-colors duration-150">
                                    <i class="pi pi-bookmark text-base! leading-none! text-primary-contrast" />
                                    <span class="font-medium text-base leading-tight">Bookmarks</span>
                                    <Badge value="3" severity="contrast" class="ml-auto h-5! min-w-5! text-xs! font-bold! leading-tight! rounded-xl! bg-primary-contrast text-primary" />
                                </a>
                            </li>
                            <li>
                                <a class="flex items-center cursor-pointer p-3 gap-2 rounded-lg text-primary-contrast hover:bg-primary-emphasis transition-colors duration-150">
                                    <i class="pi pi-users text-base! leading-none! text-primary-contrast" />
                                    <span class="font-medium text-base leading-tight">Team</span>
                                </a>
                            </li>
                            <li>
                                <a class="flex items-center cursor-pointer p-3 gap-2 rounded-lg text-primary-contrast hover:bg-primary-emphasis transition-colors duration-150">
                                    <i class="pi pi-inbox text-base! leading-none! text-primary-contrast" />
                                    <span class="font-medium text-base leading-tight">Messages</span>
                                    <Badge value="1" severity="contrast" class="ml-auto h-5! min-w-5! text-xs! font-bold! leading-tight! rounded-xl! bg-primary-contrast text-primary" />
                                </a>
                            </li>
                            <li>
                                <a class="flex items-center cursor-pointer p-3 gap-2 rounded-lg text-primary-contrast hover:bg-primary-emphasis transition-colors duration-150">
                                    <i class="pi pi-calendar text-base! leading-none! text-primary-contrast" />
                                    <span class="font-medium text-base leading-tight">Calendar</span>
                                </a>
                            </li>
                        </ul>
                    </li>
                ...
                <ul class="list-none m-0 flex flex-col gap-1">
                    <li>
                        <div
                            ...
                            class="flex items-center cursor-pointer p-3 gap-4 rounded-lg text-surface-0 hover:bg-primary-emphasis transition-colors duration-150"
                        >
                            <span class="font-semibold text-base leading-tight text-primary-contrast">Organization</span>
                            <i class="pi pi-angle-down text-base! leading-none! text-primary-contrast ml-auto" />
                        </div>
                        <ul class="list-none m-0 overflow-hidden flex flex-col gap-1 mt-1 pl-0">
                            <li>
                                <a class="flex items-center cursor-pointer p-3 gap-2 rounded-lg text-primary-contrast hover:bg-primary-emphasis transition-colors duration-150">
                                    <i class="pi pi-sitemap text-base! leading-none! text-primary-contrast" />
                                    <span class="font-medium text-base leading-tight">Overview</span>
                                </a>
                            </li>
                            <li>
                                <a
                                ...
                                >
                                    <i class="pi pi-shield text-base! leading-none! text-primary-contrast" />
                                    <span class="font-medium text-base leading-tight">Security</span>
                                    <i class="pi pi-angle-down text-base! leading-none! text-primary-contrast ml-auto" />
                                </a>
                                <ul class="list-none py-0 pl-8 pr-0 m-0 hidden overflow-y-hidden transition-all duration-400 ease-in-out flex flex-col gap-1 mt-1">
                                    <li>
                                        <a
                                            v-styleclass="{
                                                        selector: '@next',
                                            ...
                                            class="flex items-center cursor-pointer p-3 gap-2 rounded-lg text-primary-contrast hover:bg-primary-emphasis transition-colors duration-150"
                                        >
                                            <i class="pi pi-lock text-base! leading-none! text-primary-contrast" />
                                            <span class="font-medium text-base leading-tight">Permissions</span>
                                            <i class="pi pi-angle-down ml-auto text-base! leading-none! text-primary-contrast" />
                                        </a>
                                        <ul class="list-none py-0 pl-8 pr-0 m-0 hidden overflow-y-hidden transition-all duration-400 ease-in-out flex flex-col gap-1 mt-1">
                                            <li>
                                                <a class="flex items-center cursor-pointer p-3 gap-2 rounded-lg text-primary-contrast hover:bg-primary-emphasis transition-colors duration-150">
                                                    <i class="pi pi-users text-base! leading-none! text-primary-contrast" />
                                                    <span class="font-medium text-base leading-tight">User Access</span>
                                                </a>
                                            </li>
                                            <li>
                                                <a class="flex items-center cursor-pointer p-3 gap-2 rounded-lg text-primary-contrast hover:bg-primary-emphasis transition-colors duration-150">
                                                    <i class="pi pi-history text-base! leading-none! text-primary-contrast" />
                                                    <span class="font-medium text-base leading-tight">Audit Log</span>
                                                </a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li>
                                        <a class="flex items-center cursor-pointer p-3 gap-2 rounded-lg text-primary-contrast hover:bg-primary-emphasis transition-colors duration-150">
                                            <i class="pi pi-bell text-base! leading-none! text-primary-contrast" />
                            ...
                            <li>
                                <a class="flex items-center cursor-pointer p-3 gap-2 rounded-lg text-primary-contrast hover:bg-primary-emphasis transition-colors duration-150">
                                    <i class="pi pi-globe text-base! leading-none! text-primary-contrast" />
                                    <span class="font-medium text-base leading-tight">Domains</span>
                                </a>
                            </li>
                            <li>
                                <a class="flex items-center cursor-pointer p-3 gap-2 rounded-lg text-primary-contrast hover:bg-primary-emphasis transition-colors duration-150">
                                    <i class="pi pi-copy text-base! leading-none! text-primary-contrast" />
                                    <span class="font-medium text-base leading-tight">Reports</span>
                                    <Badge value="4" severity="contrast" class="ml-auto h-5! min-w-5! text-xs! font-bold! leading-tight! rounded-xl! bg-primary-contrast text-primary" />
                                </a>
                            </li>
                        </ul>
                    </li>
