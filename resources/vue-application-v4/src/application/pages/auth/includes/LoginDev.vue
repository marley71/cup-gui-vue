  ...
  <div class="flex flex-col gap-6 w-full">
    ...
    <div class="flex flex-col gap-6 w-full">
      <IconField>
        ...
        <InputText v-model="email" type="text" class="w-full px-3 py-2 shadow-sm rounded-lg" placeholder="Username"/>
      </IconField>
      <IconField>
    ...
    <Button label="Login" icon="fa fa-user" class="w-full py-2 rounded-lg flex justify-center items-center gap-2"
      @click="login"
    >
      <template #icon>
        <i class="far fa-user text-base! leading-normal!"/>
      </template>
    </Button>
