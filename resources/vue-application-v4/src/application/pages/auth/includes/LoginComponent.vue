        ...
        <div class="flex flex-col items-center gap-8 w-full">
            <div class="flex flex-col gap-6 w-full">
                <IconField>
                    ...
                    <InputText v-model="email" type="text" class="appearance-none! border! border-primary/10! w-full! outline-0! bg-primary/10! text-black! placeholder:text-black/70! rounded-3xl! shadow-xs!" placeholder="Username" />
                </IconField>
                <IconField>
            ...
            <Button label="Login" class="w-full! rounded-3xl! bg-primary-600! border! border-primary-600! text-white! hover:bg-surface-950/80!" @click="login" />
        </div>
