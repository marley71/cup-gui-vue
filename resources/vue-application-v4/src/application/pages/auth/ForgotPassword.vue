...
function sendEmail() {
  ...
  cs.Server.post('/api/forgot-password', {
    email: email.value,
  }, function (json) {
    ...
    <div
      ...
      <div class="flex flex-col items-center gap-4">
        ...
        <div class="flex flex-col gap-6 w-full">
          ...
          <div class="flex flex-col gap-6 w-full">
            <div class="pt-4 guest-sign-in text-xl text-left">Inserisci il tuo indirizzo e-mail per effettuare
              il
            ...
            <Button label="Invia e-mail" icon="fa fa-envelope" class="w-full py-2 rounded-lg flex justify-center items-center gap-2"
                    @click="sendEmail"
            >
              <template #icon>
