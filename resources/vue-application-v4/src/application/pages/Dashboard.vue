<template>
   <div class="flex flex-column gap-5 align-items-center">
       <h1 style="font-size:5em">Dashboard Applicazione 2</h1>
       <div class="grid layout-dashboard">
           <div class="col-12 md:col-6 lg:col-3">
               <div class="overview-box card">
                   ...
                   <div class="overview-box-status">+8.9% <i class="pi pi-arrow-circle-up"></i></div>
               </div>
           </div>
           <div class="col-12 md:col-6 lg:col-3">
               <div class="overview-box card">
                   ...
                   <div class="overview-box-status">+67.2% <i class="pi pi-arrow-circle-up"></i></div>
               </div>
           </div>
           <div class="col-12 md:col-6 lg:col-3">
               <div class="overview-box card">
                   ...
                   <div class="overview-box-status">+3.0% <i class="pi pi-arrow-circle-up"></i></div>
               </div>
           </div>
           <div class="col-12 md:col-6 lg:col-3">
               <div class="overview-box card">
                   ...
                   <div class="overview-box-status">+12.5% <i class="pi pi-arrow-circle-up"></i></div>
               </div>
           </div>
               ...
               <div class="card card-w-title team">
                   ...
                   <ul>
                       ...
                       <li>
                           ...
                           <a href="#"> <i class="pi pi-comment"></i> </a
                           ><a href="#">
                           <i class="pi pi-share-alt"></i>
                       </a>
                       </li>
                   ...
                   <DataTable :value="products" responsiveLayout="scroll" :rows="5" style="margin-bottom: 20px" :paginator="true">
                       <Column headerStyle="width:10%; min-width:8rem;">
                           ...
                           <template #body="slotProps">
                               ...
                               <img :src="'@/rome-vue-v4.0.0/demo/images/product/' + slotProps.data.image" :alt="slotProps.data.image" width="50" />
                           </template>
                       </Column>
