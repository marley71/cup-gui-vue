<template>
    <div class="bg-surface-0 dark:bg-surface-950 px-12 py-20 md:px-20 xl:px-80">
        <div class="flex flex-col items-center justify-center gap-8 min-h-140">
            ...
            <div class="flex flex-col items-center gap-4 w-full">
                <h1 class="text-5xl font-bold text-surface-900 dark:text-surface-0 text-center leading-tight">Page Not Found</h1>
                <p class="text-lg text-surface-500 dark:text-surface-300 text-center leading-normal">Sorry, we couldn't find the page.</p>
            </div>
            <Button icon="pi pi-arrow-left" label="Back to Home" text @click="goDashboard" />
        </div>
    </div>
</template>
<script setup>
