...
return [
    ...
    'cupparis-primevue-branch' => 'v4',  // branch libreria cupparis-primevue
    ...
    'env' => [
        'local' => [  // crea il file env per vite .env.local
            ...
            "APP_CERT_PATH" => env('VUEAPP_CERT_FOLDER',null),  // path dove si trovano i certificati per il websocket secure i nomi che cercherà vite sono key.pem e cert.pem
