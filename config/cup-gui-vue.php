...
return [
    ...
    'env' => [
        'local' => [  // crea il file env per vite .env.local
            ...
            "VITE_MODE"=> "dev",
            "VITE_RESOURCES_PATH" => base_path(env('VUEAPP_APPLICATION_PATH','resources/vue-application-v3')), // path dove ci saranno le risorse dell'applicazione
            ...
            "APP_RESOURCES_PATH" => base_path(env('VUEAPP_APPLICATION_PATH','resources/vue-application-v3')), // path dove ci saranno le risorse dell'applicazione
            ...
            "VITE_PUBLISH_DIR" => '/@fs/' . base_path(env('VUEAPP_APPLICATION_PATH','resources/vue-application-v3') . '/src/assets/html-template/'),
        ],
    ...
    "application_path" => base_path(env('VUEAPP_FOLDER','resources') . '/vue-application-v3'),
